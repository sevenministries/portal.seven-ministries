...
function logout() {
  openModal("Sign out?", `
    ...
    <div style="display:flex; gap:10px; justify-content:flex-end">
      <button class="btn btn-outline-dark btn-sm" data-close-modal>Cancel</button>
      <button class="btn btn-gold btn-sm" id="confirm-logout-btn">Yes, sign out</button>
    </div>
  `);
...
function init() {
  ...
  $("#public-brand").addEventListener("click", () => {
